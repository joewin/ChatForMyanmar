package com.joe.chat.androidclient.chat;
...
//import com.joe.chatandroidclient.R;
...
import com.joe.chat.androidclient.service.IXMPPChatService;
...
public class ChatWindow extends SherlockListActivity implements OnKeyListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mChatFontSize = Integer.valueOf(ChatForMyanmar.getConfig(this).chatFontSize);
		//AssetManager assets = getAssets();
		//face = Typeface.createFromAsset(assets,"fonts/zawgyi1.ttf");
		//change font here
		face =ChatForMyanmar.getConfig(this).getFont(ChatWindow.this);
	...
	private void registerXMPPService() {
		...
		mServiceIntent.setAction("com.joe.chat.androidclient.XMPPSERVICE");
