...
import com.joe.chat.androidclient.data.ChatProvider;
import com.joe.chat.androidclient.data.ChatProvider.ChatConstants;
import com.joe.chat.androidclient.data.RosterProvider;
import com.joe.chat.androidclient.data.RosterProvider.RosterConstants;
import com.joe.chat.androidclient.data.YaximConfiguration;
import com.joe.chat.androidclient.dialogs.AddRosterItemDialog;
import com.joe.chat.androidclient.dialogs.ChangeStatusDialog;
import com.joe.chat.androidclient.dialogs.FirstStartDialog;
import com.joe.chat.androidclient.dialogs.GroupNameView;
import com.joe.chat.androidclient.preferences.MainPrefs;
import com.joe.chat.androidclient.service.XMPPService;
import com.joe.chat.androidclient.util.AdapterConstants;
import com.joe.chat.androidclient.util.ConnectionState;
import com.joe.chat.androidclient.util.PreferenceConstants;
import com.joe.chat.androidclient.util.StatusMode;
...
import com.joe.chat.androidclient.util.SimpleCursorTreeAdapter;
import android.widget.TextView;
import android.widget.Toast;
import android.widget.ExpandableListView.ExpandableListContextMenuInfo;
import com.joe.chat.androidclient.IXMPPRosterCallback;
import com.joe.chat.R;
import com.joe.chat.androidclient.IXMPPRosterCallback.Stub;
import com.joe.chat.androidclient.service.IXMPPRosterService;
...
public class MainWindow extends SherlockExpandableListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mConfig = ChatForMyanmar.getConfig(this);
		mTheme = mConfig.theme;
		setTheme(mConfig.getTheme());
		super.onCreate(savedInstanceState);
		//change fontface here
		face =mConfig.getFont(MainWindow.this);
	...
	protected void onPause() {
		...
		ChatForMyanmar.getApp(this).mMTM.unbindDisplayActivity(this);
		unbindXMPPService();
		storeExpandedState();
	}
	...
	protected void onResume() {
		...
		ChatForMyanmar.getApp(this).mMTM.bindDisplayActivity(this);
	...
	private void startChatActivity(String user, String userName, String message) {
		Intent chatIntent = new Intent(this,
				com.joe.chat.androidclient.chat.ChatWindow.class);
		Uri userNameUri = Uri.parse(user);
		chatIntent.setData(userNameUri);
		chatIntent.putExtra(com.joe.chat.androidclient.chat.ChatWindow.INTENT_EXTRA_USERNAME, userName);
		if (message != null) {
			chatIntent.putExtra(com.joe.chat.androidclient.chat.ChatWindow.INTENT_EXTRA_MESSAGE, message);
		}
	...
	private void registerXMPPService() {
		...
		xmppServiceIntent.setAction("com.joe.chat.androidclient.XMPPSERVICE");
